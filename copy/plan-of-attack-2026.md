...
- **Legal pages — drafted 2026-08-25, found uncommitted 2026-08-29:** `copy/privacy-policy.md`, `copy/terms-and-conditions.md`, `copy/disclaimers.md`. **All three confirmed live** (direct fetch 2026-08-29, dated 25 August 2026) — Robert had already published them, just hadn't committed the local drafts. This also clears a real blocker: LIPS-CRM's booking-flow Google OAuth verification was waiting on `lipservices.com.au/privacy` being live with real content (see `LIPS-CRM/docs/brief-booking-scarcity-flow.md`) — Robert can now submit for Google's sensitive-scope verification. **One real action left:** delete the old `/disclosures` page (2022 investment-style boilerplate, confirmed still live 2026-08-29) now that `/disclaimers` carries the real content — Robert's own to-do, WP admin side.
